...
/* 
Let's continue with our football betting app! This time, we have a map with a log of the events that happened during the game. The values are the events themselves, and the keys 
...
//console.log("Events:", events);  // Output: [ '⚽️ GOAL', '🔁 Substitution', '🔶 Yellow card', '🔴 Red card' ]
...
//console.log(time);
//console.log(`An event happened, on average, every ${time / 
